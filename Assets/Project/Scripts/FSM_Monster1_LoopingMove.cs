...
public class FSM_Monster1_LoopingMove : VMyState<FSM_Monster1State>
{
    ...
    // protected override void OnNotify(FSM_Monster1Notify t, FSM_Monster1_LoopingMove_Param data)
    // {
    //     base.OnNotify(t, data);
    //
    //     switch (t)
    //     {
    //         case FSM_Monster1Notify.FSM_Monster1Notify_Stun:
