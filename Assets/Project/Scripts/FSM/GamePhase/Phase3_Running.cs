...
public class Phase3_Running  : VMyState<PhaseState>
{
    public int SpawnMonsterCount = 10;
    public float Interval = 1.0f;
    
    public bool isSpawn;
    public override PhaseState StateEnum => PhaseState.Phase3_Running;
    ...
    protected override void ExcuteState()
    {
        ...
        if (!isSpawn)
        {
            ...
            OwnerStateMachine.ChangeState(PhaseState.PhaseBoss_Ready);
        }
